...
frame = framebuf.FrameBuffer(buf,16,8,framebuf.MONO_VLSB)
frame.pixel(0,0,1)
frame.pixel(0,7,1)
frame.pixel(15,0,1)
frame.pixel(15,7,1)
frame.rect(1,1,14,6,1)
frame.line(0,7,15,0,1)
frame.line(0,0,15,7,1)
print('————————————————')
print(frame)
print('————————————————')
# buf = bytearray(16*8*2)
# frame = framebuf.FrameBuffer(buf,16,8,framebuf.RGB565)
# frame.pixel(0,0,4096)
# print(buf)
